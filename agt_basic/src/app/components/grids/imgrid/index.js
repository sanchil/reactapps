import React, { useCallback, createRef, useState, useContext, useMemo } from 'react';
...
import {getHomeImages} from '../../../data/queries';
...
export const ImgGrid = (props) => {
    ...
    //console.log('Homes are: '+ JSON.stringify(homes));
    ...
    const handleImgGridNav = (val) => e => {
        ...
        if (val === 'left') {
            start = (start <= (urlArray.length - 8)) ? (start + page) : start;
    ...
    // console.log('Homes Array : '+ JSON.stringify(homes));
            ...
            <Box className={classes.imgframe}>
                ...
                <Box className={classes.imgcontent}>
                    ...
                    <Box className={classes.imgbox2}>
                        ...
                        <Cnv w={400} h={300} overlay={true} src={urlArray[++start]} >
                    ...
                    <Box className={classes.imgbox2} style={{ borderBottomLeftRadius: 15 }}>
                        ...
                        <Cnv w={400} h={300} overlay={true} src={urlArray[++start]} position={"bottomleft"} >
                            <ApptInfo info={homes[start]} size="large" />
                        </Cnv>
                    </Box>
                    <Box className={classes.imgbox2}>
                ...
                <Box className={classes.imgcontent}>
                    ...
                    <Box className={classes.imgbox3} style={{ borderTopRightRadius: 15 }}>
                        ...
                        <Cnv w={800} h={300} overlay={true} src={urlArray[++start]} position={"topright"} >
                            <ApptInfo info={homes[start]} size="large" />
                        </Cnv>
                    </Box>
                    ...
                    <Box className={classes.imgbox1} style={{ borderBottomRightRadius: 15 }}>
                        ...
                        <Cnv w={800} h={600} overlay={true} src={urlArray[++start]} position={"bottomright"} >
                            <ApptInfo info={homes[start]} size="medium" />
                        </Cnv>
                    </Box>
