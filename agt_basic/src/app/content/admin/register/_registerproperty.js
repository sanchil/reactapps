...
import { addHome } from '../../../data/queries';
...
const RegisterProperty = (props) => {
    ...
    const handleSubmit = e => {
        regHomeData.dataorigin = 'REGISTER';
        regHomeData.subtype = 'listhome';
        addHome(regHomeData, regImgData)
            .then(res => console.log("Home added successfully" + JSON.stringify(res)))
            .catch(err => console.log('Error adding home' + JSON.stringify(err)));
    }
