...
export const HOST = 'webapp.org';
export const DB = '/hgilldb';

// URLS used by local APP #webapp.org
export const DBURL = 'https://'+HOST+'/db'+DB;
export const SESSIONURL = 'https://'+HOST+'/session';
...
//export const SESSIONURL = 'https://172.31.44.58/rsess';
...
export const CLOUDINARY = cloudinary.Cloudinary.new(CLOUDINARY_CONFIG);
...
export const TW_REQTOKEN_ACCESSTOKEN_EP = 'https://api.twitter.com/oauth/access_token';
